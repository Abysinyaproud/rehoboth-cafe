...
- `business-card-hiwote.jpg`
- `business-card-michael.jpg`
- `fb-banner.jpg`
- `Blank-post-template1.jpg` through `Blank-post-template4.jpg`
- Ethiopian source artwork in `.ai` files

Applied digital palette:
