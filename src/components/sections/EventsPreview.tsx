...
export function EventsPreview() {
  return (
    <Section
      ...
      intro="Tastings, cultural nights, and ceremony experiences give regulars a rhythm and first-time visitors a reason to choose Rehoboth now."
    >
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        {events.map((event) => (
          <article
            key={event.title}
            className="rounded-rehoboth border border-espresso/10 bg-ivory p-7 transition duration-300 ease-luxury hover:bg-white"
          >
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-clay">
              {event.date}
            </p>
            <h3 className="mt-5 font-display text-3xl leading-tight">{event.title}</h3>
      ...
      <div className="mt-6">
        <EmptyState
          ...
          title="Gatherings are part of the Rehoboth rhythm."
